...
describe("utils", () => {
  ...
  describe("#encode", () => {
    ...
    it("plain option", () => {
      // Source.
      const encoded = utils.encode({
        plaintext: true,
        args: ["olga", "chexova111"]
      });
  ...
  describe("#verify", () => {
    ...
    it("wrong sha1 pass", () => {
      // Source.
      const result = utils.verify(
        "{SHA}hGJRiZy8gBpNMHvs1UOTqIrRU20=",
        "bannana"
      );
    ...
    it("correct MD5 pass", () => {
      // Source.
      const result = utils.verify(
        "$apr1$Ny3hkBdz$UReNPq7yEH6Y/D/FXUPwI/",
        "mia"
      );
    ...
    it("correct old bcrypt pass", () => {
      // Source.
      const result = utils.verify(
        "$2a$05$c4WoMPo3SXsafkva.HHa6uXQZWr7oboPiC2bT/r7q1BB8I2s0BRqC",
        "myPassword"
      );
